...
Assert-True ($expected.Count -eq 16) 'Closed security inventory is not exactly 16 reviewed modules.'
Write-Output 'PASS: reconciler, release-safety, plugin packaging and committed HEAD agree on the exact 16-module security inventory.'