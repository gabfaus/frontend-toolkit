...
Assert-True ($cli.supplyChainException.releaseAcceptance -eq 'ACCEPT_WITH_RESTRICTIONS' -and $cli.supplyChainException.issue -eq 'microsoft/playwright#42500' -and $cli.supplyChainException.trustedPublisher -eq 'ABSENT' -and $cli.supplyChainException.sigstoreSlsa -eq 'ABSENT') 'Final Playwright release acceptance is missing or pending.'
