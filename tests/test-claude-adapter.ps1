...
Assert-Equal $codexManifest.version '1.3.0' 'Codex public version'
Assert-Equal $metadata.version '1.3.0' 'Common public version'
Assert-Equal $claudeManifest.version '1.3.0' 'Claude public version'
